...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0) ? (sword_t)src1 / (sword_t)src2 : (sword_t)-1);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2 != 0) ? (uint64_t)(sword_t)src1 / (uint64_t)(sword_t)src2 : (word_t)-1);
