...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = (src2 != 0) ? (uint64_t)(int32_t)src1 % (uint64_t)(int32_t)src2 : src1);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0) ? (int32_t)src1 / (int32_t)src2 : ((src1 < 0) ? -1 : -1));
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2 != 0) ? (uint64_t)(int32_t)src1 / (uint64_t)(int32_t)src2 : ((src1 < 0) ? -1 : -1));
