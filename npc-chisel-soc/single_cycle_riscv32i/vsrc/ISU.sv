...
module ISU(	// @[src/main/core/isu/ISU.scala:56:7]
  ...
  input  [2:0]  io_pipe_in_bits_id2is_bjtpe,	// @[src/main/core/isu/ISU.scala:57:21]
  ...
  output [2:0]  io_pipe_out_bits_is2exe_bjtpe,	// @[src/main/core/isu/ISU.scala:57:21]
  ...
  reg         out_valid;	// @[src/main/core/isu/ISU.scala:167:28]
  ...
  wire        _n_state_T_2 = io_pipe_out_ready & out_valid;	// @[src/main/core/isu/ISU.scala:167:28, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  reg         in_ready;	// @[src/main/core/isu/ISU.scala:166:27]
  reg         c_state;	// @[src/main/core/isu/ISU.scala:172:26]
  wire        n_state = c_state ? ~_n_state_T_2 : in_ready & io_pipe_in_valid;	// @[src/main/core/isu/ISU.scala:56:7, :166:27, :172:26, :173:30, :178:51, :180:33, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  always @(posedge clock) begin	// @[src/main/core/isu/ISU.scala:56:7]
    if (reset) begin	// @[src/main/core/isu/ISU.scala:56:7]
      ...
      in_ready <= 1'h0;	// @[src/main/core/isu/ISU.scala:56:7, :166:27]
      out_valid <= 1'h0;	// @[src/main/core/isu/ISU.scala:56:7, :167:28]
      c_state <= 1'h0;	// @[src/main/core/isu/ISU.scala:56:7, :172:26]
    end
      ...
      in_ready <= ~n_state | ~n_state & in_ready;	// @[src/main/core/isu/ISU.scala:166:27, :173:30, :183:20, :185:22, :189:22]
      out_valid <=
        n_state
        & (n_state
             ? ~(_ch3Ready_T_3[0]) | rs1ForEX | rs1ForWB | io_pipe_in_bits_id2is_ch1tpe
               ...
               | ~(_ch3Ready_T_3[0])
             : out_valid);	// @[src/main/core/isu/GPR.scala:27:37, src/main/core/isu/ISU.scala:98:32, :99:32, :100:32, :101:32, :104:20, :105:{20,97}, :106:{46,50,88,108,143}, :107:{20,67}, :109:40, :167:28, :173:30, :183:20, :186:23, :190:23]
      c_state <= n_state;	// @[src/main/core/isu/ISU.scala:172:26, :173:30]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/core/isu/ISU.scala:56:7]
    ...
    initial begin	// @[src/main/core/isu/ISU.scala:56:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/core/isu/ISU.scala:56:7]
        ...
        in_ready = _RANDOM[/*Zero width*/ 1'b0][16];	// @[src/main/core/isu/GPR.scala:26:21, src/main/core/isu/ISU.scala:56:7, :166:27]
        out_valid = _RANDOM[/*Zero width*/ 1'b0][17];	// @[src/main/core/isu/GPR.scala:26:21, src/main/core/isu/ISU.scala:56:7, :167:28]
        c_state = _RANDOM[/*Zero width*/ 1'b0][18];	// @[src/main/core/isu/GPR.scala:26:21, src/main/core/isu/ISU.scala:56:7, :172:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_pipe_in_ready = in_ready;	// @[src/main/core/isu/ISU.scala:56:7, :166:27]
  assign io_pipe_out_valid = out_valid;	// @[src/main/core/isu/ISU.scala:56:7, :167:28]
  ...
  assign io_pipe_out_bits_is2exe_ch2 =
    ...
    | (~(io_pipe_in_bits_id2is_ch2tpe == 2'h0 & ~(rs2ForEX | rs2ForWB))
       | io_pipe_in_bits_id2is_rs2_addr == 4'h0
         ? 32'h0
         : _gpr_ext_R0_data);	// @[src/main/core/isu/GPR.scala:11:18, :12:44, src/main/core/isu/ISU.scala:56:7, :99:32, :101:32, :105:97, :131:39, :134:{39,61,64,75}, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign io_pipe_out_bits_is2exe_ch3 =
    ...
    + io_pipe_in_bits_id2is_imm;	// @[src/main/core/isu/GPR.scala:11:18, :12:44, src/main/core/isu/ISU.scala:56:7, :106:46, :127:75, :141:{18,51,82,137}, src/main/scala/chisel3/util/Mux.scala:30:73]
