...
module IFU(	// @[src/main/core/ifu/IFU.scala:39:7]
  ...
  wire        sel_trap = flag & ~io_is_mret & ~io_br_flg & ~io_jmp_flg;	// @[src/main/core/ifu/IFU.scala:69:23, :218:42, :220:{41,45,59}]
  wire        sel_mret = flag & io_is_mret & ~io_br_flg & ~io_jmp_flg;	// @[src/main/core/ifu/IFU.scala:69:23, :220:{45,59}, :221:40]
  wire [31:0] pc_next =
    (sel_br ? io_br_target : 32'h0) | (sel_jmp ? io_alu_out : 32'h0)
    | (sel_trap ? io_csr_mtvec : 32'h0) | (sel_mret ? io_csr_mepc : 32'h0)
    | (sel_br | sel_jmp | sel_trap | sel_mret ? 32'h0 : reg_pc + 32'h4);	// @[src/main/core/ifu/IFU.scala:53:20, :208:23, :212:18, :215:27, :218:39, :219:40, :220:41, :221:40, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/core/ifu/IFU.scala:39:7]
    ...
    initial begin	// @[src/main/core/ifu/IFU.scala:39:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/core/ifu/IFU.scala:39:7]
        ...
        in_ready = _RANDOM[1'h0][6];	// @[src/main/core/ifu/IFU.scala:39:7, :66:45, :90:27]
        out_valid = _RANDOM[1'h0][7];	// @[src/main/core/ifu/IFU.scala:39:7, :66:45, :91:28]
        arvalid = _RANDOM[1'h0][8];	// @[src/main/core/ifu/IFU.scala:39:7, :66:45, :96:26]
        rready = _RANDOM[1'h0][9];	// @[src/main/core/ifu/IFU.scala:39:7, :66:45, :97:25]
        c_state = _RANDOM[1'h0][14:12];	// @[src/main/core/ifu/IFU.scala:39:7, :66:45, :106:26]
        reg_pc = {_RANDOM[1'h0][31:15], _RANDOM[1'h1][14:0]};	// @[src/main/core/ifu/IFU.scala:39:7, :66:45, :212:18]
      `endif // RANDOMIZE_REG_INIT
      if (reset)	// @[src/main/core/ifu/IFU.scala:39:7]
        reg_pc = 32'h30000000;	// @[src/main/core/ifu/IFU.scala:212:18]
    end // initial
