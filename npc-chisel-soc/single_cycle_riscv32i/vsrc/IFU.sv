...
module IFU(	// @[src/main/core/ifu/IFU.scala:39:7]
  ...
  wire [31:0] pc_next =
    io_br_flg & flag
      ...
      : io_jmp_flg & flag
          ? io_alu_out
          : flag ? io_csr_mtvec : io_is_mret & flag ? io_csr_mepc : reg_pc + 32'h4;	// @[src/main/core/ifu/IFU.scala:69:23, :208:23, :212:18, :215:27, :218:20, :219:21, :221:21, src/main/scala/chisel3/util/Mux.scala:126:16]
