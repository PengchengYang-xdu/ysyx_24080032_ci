...
module IFU(	// @[src/main/core/ifu/IFU.scala:38:7]
              ...
              : c_state == 3'h1
                  ...
                  : {2'h0,
                     c_state == 3'h0 & io_imem_arready & ~io_hazard_flush_flg
                       & io_pipe_in_valid};	// @[src/main/core/ifu/IFU.scala:38:7, :87:28, :92:26, :102:26, :103:30, :106:31, :107:37, :110:36, :114:51, :115:38, :116:38, :117:{38,70}, :118:38, :119:38, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  reg  [31:0] reg_pc;	// @[src/main/core/ifu/IFU.scala:203:18]
  wire [31:0] pc_next =
    io_br_flg & flag
      ? io_br_target
      : io_jmp_flg & flag
          ...
          : io_imem_rdata == 32'h73
              ? io_csr_mtvec
              : io_imem_rdata == 32'h30200073 ? io_csr_mepc : reg_pc + 32'h4;	// @[src/main/core/ifu/IFU.scala:65:23, :199:23, :203:18, :206:27, :209:20, :210:21, :211:24, :212:24, src/main/scala/chisel3/util/Mux.scala:126:16]
  wire        _GEN = n_state == 3'h0;	// @[src/main/core/ifu/IFU.scala:103:30, :115:38, :122:20]
  wire        _GEN_0 = n_state == 3'h1;	// @[src/main/core/ifu/IFU.scala:102:26, :103:30, :122:20]
  wire        _GEN_1 = n_state == 3'h2;	// @[src/main/core/ifu/IFU.scala:103:30, :116:38, :122:20]
  wire        _GEN_2 = n_state == 3'h3;	// @[src/main/core/ifu/IFU.scala:103:30, :117:38, :122:20]
  wire        _GEN_3 = n_state == 3'h4;	// @[src/main/core/ifu/IFU.scala:103:30, :117:70, :122:20]
  wire        _GEN_4 = _GEN_1 | _GEN_2 | _GEN_3;	// @[src/main/core/ifu/IFU.scala:86:27, :122:20, :161:22, :170:22, :179:22]
  always @(posedge clock) begin	// @[src/main/core/ifu/IFU.scala:38:7]
    if (reset) begin	// @[src/main/core/ifu/IFU.scala:38:7]
      ...
      in_ready <= _GEN | ~(_GEN_0 | _GEN_4) & in_ready;	// @[src/main/core/ifu/IFU.scala:86:27, :122:20, :125:22, :138:22, :161:22, :170:22, :179:22]
      out_valid <=
        ~_GEN
        & (_GEN_0
             ...
             : _GEN_1
                 ? io_imem_rvalid & ~(|io_imem_rresp)
                 : _GEN_2 ? io_imem_rvalid & ~(|io_imem_rresp) : ~_GEN_3 & out_valid);	// @[src/main/core/ifu/IFU.scala:87:28, :122:20, :126:23, :139:{23,41,58}, :162:{23,41,58}, :171:{23,41,58}, :180:23]
      arvalid <= ~_GEN & (_GEN_0 | ~_GEN_4 & arvalid);	// @[src/main/core/ifu/IFU.scala:86:27, :92:26, :122:20, :126:23, :128:21, :154:25, :161:22, :164:21, :170:22, :173:21, :179:22, :182:21]
      rready <= ~(_GEN | _GEN_0) & (_GEN_1 | ~_GEN_2 & (_GEN_3 | rready));	// @[src/main/core/ifu/IFU.scala:93:25, :122:20, :129:20, :155:24, :165:20, :174:20, :183:20]
  ...
  always @(posedge clock or posedge reset) begin	// @[src/main/core/ifu/IFU.scala:38:7]
    if (reset)	// @[src/main/core/ifu/IFU.scala:38:7]
      reg_pc <= 32'h30000000;	// @[src/main/core/ifu/IFU.scala:203:18]
    else if (io_pipe_in_valid)	// @[src/main/core/ifu/IFU.scala:40:21]
      reg_pc <= pc_next;	// @[src/main/core/ifu/IFU.scala:199:23, :203:18]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/core/ifu/IFU.scala:38:7]
    ...
    initial begin	// @[src/main/core/ifu/IFU.scala:38:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/core/ifu/IFU.scala:38:7]
        ...
        reg_pc = {_RANDOM[1'h0][31:18], _RANDOM[1'h1][17:0]};	// @[src/main/core/ifu/IFU.scala:38:7, :65:23, :203:18]
      `endif // RANDOMIZE_REG_INIT
      if (reset)	// @[src/main/core/ifu/IFU.scala:38:7]
        reg_pc = 32'h30000000;	// @[src/main/core/ifu/IFU.scala:203:18]
    end // initial
  ...
  assign io_imem_araddr = reg_pc;	// @[src/main/core/ifu/IFU.scala:38:7, :203:18]
  ...
  assign io_csr_reg_pc = reg_pc;	// @[src/main/core/ifu/IFU.scala:38:7, :203:18]
  ...
  assign io_pipe_out_bits_if2id_reg_pc = reg_pc;	// @[src/main/core/ifu/IFU.scala:38:7, :203:18]
