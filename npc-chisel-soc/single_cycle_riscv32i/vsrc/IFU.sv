...
module IFU(	// @[src/main/core/ifu/IFU.scala:38:7]
  ...
  wire [2:0]  n_state =
    c_state == 3'h4
      ? {~AXI_R_fire, 2'h0}
      : c_state == 3'h3
          ? (io_hazard_flush_flg | io_pipe_out_ready & out_valid ? 3'h0 : 3'h3)
          : c_state == 3'h2
              ...
              : c_state == 3'h1
                  ...
                  : {2'h0,
                     c_state == 3'h0 & io_imem_arready & ~io_hazard_flush_flg
                       & io_pipe_in_valid};	// @[src/main/core/ifu/IFU.scala:38:7, :87:28, :92:26, :102:26, :103:30, :106:31, :107:37, :110:36, :111:{26,38}, :112:{35,37}, :119:51, :120:38, :121:38, :122:{38,72,101}, :123:{38,59}, :124:38, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  always @(posedge clock) begin	// @[src/main/core/ifu/IFU.scala:38:7]
    if (reset) begin	// @[src/main/core/ifu/IFU.scala:38:7]
      ...
      out_valid <=
        ~(_GEN | _GEN_0 | _GEN_1) & (_GEN_2 ? ~io_hazard_flush_flg : ~_GEN_3 & out_valid);	// @[src/main/core/ifu/IFU.scala:87:28, :112:37, :127:20, :131:23, :144:23, :167:23, :176:23, :185:23]
