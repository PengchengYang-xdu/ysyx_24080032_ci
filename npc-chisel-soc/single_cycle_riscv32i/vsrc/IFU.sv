...
module IFU(	// @[src/main/core/ifu/IFU.scala:38:7]
  ...
  always @(posedge clock) begin	// @[src/main/core/ifu/IFU.scala:38:7]
    if (reset) begin	// @[src/main/core/ifu/IFU.scala:38:7]
      ...
      out_valid <= ~(_GEN | _GEN_0 | _GEN_1) & (_GEN_2 | ~_GEN_3 & out_valid);	// @[src/main/core/ifu/IFU.scala:87:28, :122:20, :126:23, :139:23, :162:23, :171:23, :180:23]
      arvalid <= ~_GEN & (_GEN_0 | ~_GEN_4 & arvalid);	// @[src/main/core/ifu/IFU.scala:86:27, :92:26, :122:20, :128:21, :154:25, :161:22, :164:21, :170:22, :173:21, :179:22, :182:21]
