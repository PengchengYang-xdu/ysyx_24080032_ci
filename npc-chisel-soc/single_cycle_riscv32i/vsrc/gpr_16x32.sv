...
module gpr_16x32(	// @[src/main/core/GPR.scala:22:18]
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [31:0] R0_data,
  ...
  reg [31:0] Memory[0:15];	// @[src/main/core/GPR.scala:22:18]
    ...
    initial begin	// @[src/main/core/GPR.scala:22:18]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/core/GPR.scala:22:18]
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM;	// @[src/main/core/GPR.scala:22:18]
