...
module IDU(	// @[src/main/core/idu/IDU.scala:44:7]
  ...
  wire [6:0]  _decodeBundle_orMatrixOutputs_T_21 =
    ...
    always @(posedge clock) begin	// @[src/main/core/idu/IDU.scala:58:15]
      if ((`PRINTF_COND_) & out_valid & ~reset)	// @[src/main/core/idu/IDU.scala:58:15, :132:28]
        $fwrite(32'h80000002,
                ...
                |_decodeBundle_orMatrixOutputs_T_21, decodeBundle_immtpe);	// @[src/main/core/idu/IDU.scala:58:15, src/main/scala/chisel3/util/experimental/decode/DecoderBundle.scala:88:106, src/main/scala/chisel3/util/pla.scala:114:{19,36}]
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  assign io_pipe_out_bits_id2is_rfwe = |_decodeBundle_orMatrixOutputs_T_21;	// @[src/main/core/idu/IDU.scala:44:7, src/main/scala/chisel3/util/pla.scala:114:{19,36}]
