...
module IDU(	// @[src/main/core/idu/IDU.scala:54:7]
  ...
  wire        n_state =
    ~io_flush_flush_flg
    & (c_state ? ~(io_pipe_out_ready & out_valid) : in_ready & io_pipe_in_valid);	// @[src/main/core/idu/IDU.scala:75:20, :142:27, :143:28, :148:26, :149:30, :154:29, :155:17, :157:{17,55}, :158:37, :159:37, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[src/main/core/idu/IDU.scala:54:7]
    if (reset) begin	// @[src/main/core/idu/IDU.scala:54:7]
      ...
      out_valid <= n_state & (n_state ? ~io_flush_flush_flg : out_valid);	// @[src/main/core/idu/IDU.scala:143:28, :149:30, :163:20, :166:23, :170:{23,26}]
