...
module IDU(	// @[src/main/core/idu/IDU.scala:44:7]
  ...
  wire [6:0]  _decodeBundle_orMatrixOutputs_T_22 =
    {&_decodeBundle_andMatrixOutputs_T_4,
     ...
     &_decodeBundle_andMatrixOutputs_T_21};	// @[src/main/scala/chisel3/util/pla.scala:98:{53,70}, :114:19]
  wire [1:0]  decodeBundle_processunit =
    {|{&{decodeBundle_invInputs[0], decodeBundle_invInputs[2], decodeBundle_invInputs[3]},
     ...
     |{&_decodeBundle_andMatrixOutputs_T_9,
       ...
       &_decodeBundle_andMatrixOutputs_T_17}};	// @[src/main/scala/chisel3/util/experimental/decode/DecoderBundle.scala:88:106, src/main/scala/chisel3/util/pla.scala:78:21, :91:29, :98:{53,70}, :114:{19,36}]
    ...
    always @(posedge clock) begin	// @[src/main/core/idu/IDU.scala:58:15]
      if ((`PRINTF_COND_) & out_valid & ~reset)	// @[src/main/core/idu/IDU.scala:58:15, :132:28]
        $fwrite(32'h80000002,
                ...
                |_decodeBundle_orMatrixOutputs_T_18, decodeBundle_ch2tpe,
                |_decodeBundle_orMatrixOutputs_T_22, decodeBundle_immtpe);	// @[src/main/core/idu/IDU.scala:58:15, src/main/scala/chisel3/util/experimental/decode/DecoderBundle.scala:88:106, src/main/scala/chisel3/util/pla.scala:114:{19,36}]
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  wire        n_state =
    c_state ? ~(io_pipe_out_ready & out_valid) : in_ready & io_pipe_in_valid;	// @[src/main/core/idu/IDU.scala:58:15, :131:27, :132:28, :137:26, :138:30, :143:51, :145:33, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/pla.scala:102:36]
  ...
  assign io_pipe_out_bits_id2is_rfwe = |_decodeBundle_orMatrixOutputs_T_22;	// @[src/main/core/idu/IDU.scala:44:7, src/main/scala/chisel3/util/pla.scala:114:{19,36}]
  assign io_pipe_out_bits_id2is_rd_addr = io_pipe_in_bits_if2id_inst[10:7];	// @[src/main/core/idu/IDU.scala:44:7, :63:39, :86:36]
  assign io_pipe_out_bits_id2is_ch1tpe = |_decodeBundle_orMatrixOutputs_T_18;	// @[src/main/core/idu/IDU.scala:44:7, src/main/scala/chisel3/util/pla.scala:114:{19,36}]
