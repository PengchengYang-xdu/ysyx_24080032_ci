...
module ysyx_24080032_IDU(
    ...
    //output to exu and lsu
    output [31:0] o_exu_lsu_rs2,

    //output to exu and wbu
    output [31:0] o_exu_wbu_rs1,

    //output to wbu
    output [1:0] o_wbu_MemtoReg,
    output o_wbu_WcsrSrc,

    //output to wbu and exu
    output [31:0] o_wbu_exu_Rcsr,
    ...
    //output to ifu and exu
    output [31:0] o_ifu_exu_imm
);
...
ysyx_24080032_ctrgen u_ysyx_24080032_ctrgen(
    ...
    .ALUctr   (o_exu_ALUctr          ),
    .Branch   (o_exu_Branch          ),
    .MemtoReg (o_wbu_MemtoReg        ),
    .WcsrSrc  (o_wbu_WcsrSrc         ),
    .MemWr    (o_lsu_MemWr           ),
    .MemRd    (o_lsu_MemRd           ),
    .MemOp    (o_lsu_MemOp           ),
    .irq      (o_ifu_irq             )
