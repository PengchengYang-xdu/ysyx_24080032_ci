...
object MiscInfo_build {
  implicit lazy val millBuildRootModuleInfo: _root_.mill.runner.MillBuildRootModule.Info = _root_.mill.runner.MillBuildRootModule.Info(
    Vector("/home/yangpengcheng/ysyx/ysyx/ysyx-workbench/npc/out/mill-launcher/0.11.5.jar").map(_root_.os.Path(_)),
    _root_.os.Path("/home/yangpengcheng/ysyx/ysyx/ysyx-workbench/npc"),
    _root_.os.Path("/home/yangpengcheng/ysyx/ysyx/ysyx-workbench/npc"),
    _root_.scala.Seq()
  )
...
//MILL_ORIGINAL_FILE_PATH=/home/yangpengcheng/ysyx/ysyx/ysyx-workbench/npc/build.sc
