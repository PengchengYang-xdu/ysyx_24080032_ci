...
module ysyx_24080032_IFU(	// @[src/main/core/ifu/IFU.scala:50:7]
  ...
  wire        _n_state_T_5 = io_pipe_out_ready & io_pipe_out_valid_0;	// @[src/main/core/ifu/IFU.scala:112:36, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35]
      ...
      : c_state == 3'h3
          ...
          : c_state == 3'h2
              ...
              : c_state == 3'h1
                  ...
                  : {2'h0,
                     c_state == 3'h0 & io_pipe_in_valid & io_imem_arready & ~flush_flg};	// @[src/main/core/ifu/IFU.scala:50:7, :70:30, :112:39, :114:26, :121:26, :122:30, :125:31, :126:37, :128:{35,54}, :130:36, :131:{26,38}, :132:35, :136:51, :137:38, :138:38, :139:{38,72,101}, :140:{38,56}, :141:38, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35]
  always @(posedge clock or posedge reset) begin	// @[src/main/core/ifu/IFU.scala:50:7]
    ...
    else if (_n_state_T_5 | io_bj_valid | io_fencei_flush_icache_fencing)	// @[src/main/core/ifu/IFU.scala:67:{57,72}, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35]
      reg_pc <= pc_next;	// @[src/main/core/ifu/IFU.scala:60:23, :67:18]
  end // always @(posedge, posedge)
  wire        _GEN = n_state == 3'h0;	// @[src/main/core/ifu/IFU.scala:122:30, :144:20]
  wire        _GEN_0 = n_state == 3'h1;	// @[src/main/core/ifu/IFU.scala:121:26, :122:30, :144:20]
  wire        _GEN_1 = n_state == 3'h2;	// @[src/main/core/ifu/IFU.scala:122:30, :144:20]
