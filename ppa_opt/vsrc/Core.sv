  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/core/Core.scala:24:7]
    ...
    initial begin	// @[src/main/core/Core.scala:24:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/core/Core.scala:24:7]
        ...
        isu_io_pipe_in_valid_r = _RANDOM[4'h5][9];	// @[src/main/core/Core.scala:24:7, :102:33, :103:34]
        exu_io_pipe_in_bits_r_is2exe_processunit = _RANDOM[4'h5][11:10];	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_processtpe = _RANDOM[4'h5][15:12];	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_bjtpe = _RANDOM[4'h5][19:16];	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_rfwe = _RANDOM[4'h5][20];	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_rd_addr = _RANDOM[4'h5][24:21];	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_ch1 = {_RANDOM[4'h5][31:25], _RANDOM[4'h6][24:0]};	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_ch2 = {_RANDOM[4'h6][31:25], _RANDOM[4'h7][24:0]};	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_bits_r_is2exe_ch3 = {_RANDOM[4'h7][31:25], _RANDOM[4'h8][24:0]};	// @[src/main/core/Core.scala:24:7, :102:33]
        exu_io_pipe_in_valid_r = _RANDOM[4'h8][25];	// @[src/main/core/Core.scala:24:7, :102:33, :103:34]
        wbu_io_pipe_in_bits_r_exe2wb_gpr_we = _RANDOM[4'h8][26];	// @[src/main/core/Core.scala:24:7, :102:33]
        wbu_io_pipe_in_bits_r_exe2wb_gpr_wdata =
          {_RANDOM[4'h8][31:27], _RANDOM[4'h9][26:0]};	// @[src/main/core/Core.scala:24:7, :102:33]
        wbu_io_pipe_in_bits_r_exe2wb_gpr_waddr = _RANDOM[4'h9][30:27];	// @[src/main/core/Core.scala:24:7, :102:33]
        wbu_io_pipe_in_valid_r = _RANDOM[4'h9][31];	// @[src/main/core/Core.scala:24:7, :102:33, :103:34]
      `endif // RANDOMIZE_REG_INIT
    end // initial
