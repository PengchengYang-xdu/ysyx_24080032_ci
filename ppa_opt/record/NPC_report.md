...
Generate the report at 2025-08-28T12:58:57, GitVersion: aa25008b3778a76ae1975c839d4cc459f7f7b3b7.
+----------------+-------------+------------+------------+---------------+-------+-------+-----------+
| Endpoint       | Clock Group | Delay Type | Path Delay | Path Required | CPPR  | Slack | Freq(MHz) |
+----------------+-------------+------------+------------+---------------+-------+-------+-----------+
| core/_7366_:D  | core_clock  | max        | 1.607f     | 1.961         | 0.000 | 0.353 | 607.314   |
| core/_7362_:D  | core_clock  | max        | 1.607f     | 1.961         | 0.000 | 0.353 | 607.314   |
| core/_7368_:D  | core_clock  | max        | 1.607f     | 1.961         | 0.000 | 0.353 | 607.314   |
| clint/_1144_:D | core_clock  | min        | 0.066r     | 0.006         | 0.000 | 0.060 | NA        |
| clint/_1144_:D | core_clock  | min        | 0.065f     | 0.003         | 0.000 | 0.062 | NA        |
| core/_7331_:D  | core_clock  | min        | 0.081f     | 0.002         | 0.000 | 0.079 | NA        |
+----------------+-------------+------------+------------+---------------+-------+-------+-----------+

### Chip area info from synth_stat.txt
   Chip area for module '\CSR': 1582.966000
   Chip area for module '\Clint': 1034.740000
   Chip area for module '\Core': 6490.134000
   Chip area for module '\EXU': 2503.326000
   Chip area for module '\GPR': 6108.690000
   ...
   Chip area for top module '\NPC': 30130.352000
