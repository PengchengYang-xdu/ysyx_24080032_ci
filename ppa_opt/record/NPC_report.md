...
Generate the report at 2025-08-27T21:27:54, GitVersion: aa25008b3778a76ae1975c839d4cc459f7f7b3b7.
+------------------+-------------+------------+------------+---------------+-------+-------+-----------+
| Endpoint         | Clock Group | Delay Type | Path Delay | Path Required | CPPR  | Slack | Freq(MHz) |
+------------------+-------------+------------+------------+---------------+-------+-------+-----------+
| core/ifu/_810_:D | core_clock  | max        | 1.652r     | 2.191         | 0.000 | 0.539 | 594.007   |
| core/ifu/_811_:D | core_clock  | max        | 1.637r     | 2.191         | 0.000 | 0.554 | 599.549   |
| core/ifu/_812_:D | core_clock  | max        | 1.633r     | 2.191         | 0.000 | 0.558 | 601.007   |
| clint/_1144_:D   | core_clock  | min        | 0.066r     | 0.006         | 0.000 | 0.060 | NA        |
| clint/_1144_:D   | core_clock  | min        | 0.065f     | 0.003         | 0.000 | 0.062 | NA        |
| core/_7319_:D    | core_clock  | min        | 0.081f     | 0.002         | 0.000 | 0.079 | NA        |
+------------------+-------------+------------+------------+---------------+-------+-------+-----------+
...
### Chip area info from synth_stat.txt
   ...
   Chip area for module '\GPR': 6475.770000
   Chip area for module '\IDU': 1502.634000
   Chip area for module '\IFU': 622.972000
   Chip area for module '\LSU': 1959.356000
   ...
   Chip area for top module '\NPC': 30438.912000
