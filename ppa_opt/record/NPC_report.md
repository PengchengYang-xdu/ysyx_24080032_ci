...
Generate the report at 2025-08-27T23:36:09, GitVersion: aa25008b3778a76ae1975c839d4cc459f7f7b3b7.
+----------------+-------------+------------+------------+---------------+-------+-------+-----------+
| Endpoint       | Clock Group | Delay Type | Path Delay | Path Required | CPPR  | Slack | Freq(MHz) |
+----------------+-------------+------------+------------+---------------+-------+-------+-----------+
| core/_6883_:D  | core_clock  | max        | 1.472f     | 1.961         | 0.000 | 0.488 | 661.584   |
| core/_6875_:D  | core_clock  | max        | 1.472f     | 1.961         | 0.000 | 0.488 | 661.584   |
| core/_6885_:D  | core_clock  | max        | 1.472f     | 1.961         | 0.000 | 0.488 | 661.584   |
| clint/_1144_:D | core_clock  | min        | 0.066r     | 0.006         | 0.000 | 0.060 | NA        |
| clint/_1144_:D | core_clock  | min        | 0.065f     | 0.003         | 0.000 | 0.062 | NA        |
| core/_6820_:D  | core_clock  | min        | 0.081f     | 0.002         | 0.000 | 0.079 | NA        |
+----------------+-------------+------------+------------+---------------+-------+-------+-----------+

### Chip area info from synth_stat.txt
   Chip area for module '\CSR': 1582.966000
   Chip area for module '\Clint': 1034.740000
   Chip area for module '\Core': 6132.098000
   Chip area for module '\EXU': 2291.058000
   Chip area for module '\GPR': 6369.104000
   Chip area for module '\IDU': 1480.822000
   ...
   Chip area for top module '\NPC': 29798.650000
